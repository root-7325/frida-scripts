//by root7325
//for v19 (minor u gotta suggest by yourself :upside_down);
//and perhaps this will work only with frida cli tools

console.log(format("codename: {0}", "rooty tooty"));

var cache = {};

const SERVER_CONNECTION = 0xA54164;
const CREATE_MESSAGE_BY_TYPE = 0x1C0E4C;
